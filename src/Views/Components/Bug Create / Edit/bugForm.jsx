    ...
    return(
        <div className='bug-create'>
            ...
            <form>
                ...
                <label>Details:</label>
                <textarea name='details' placeholder='Detailed description of bug' required onChange={inputChanged} value={bugObject.details}></textarea>
                <label>Steps:</label>
